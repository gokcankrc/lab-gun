...
public class HintStorage : MonoBehaviour
{
    public string[] hints = {
        ...
        "Hint 3 - lvl 1 (note or FS): Pay attention to the colors of objects, they might prove crucial for escaping",
        ...
        "Hint 6 - lvl (xxx): Colored objects can assign you a tag to unlock a certain door BUT pay attention as hitting other objects or projectiles can strip you of your tag",
        ...
        "Hint 11 - lvl (xxx): Hold R to use your time rewind ability to return to your spawn and try a different route",
        ...
        "These walls could never be breached, they are the peak of human engineering",
